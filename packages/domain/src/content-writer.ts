...
function lifecycleStatusOf(input: { lifecycleStatus?: "ongoing" | "completed" | "hiatus"; status?: "ongoing" | "completed" | "hiatus" }): "ongoing" | "completed" | "hiatus" {
    return input.lifecycleStatus ?? input.status ?? "ongoing";
}
...
export class FileContentWriter implements ContentWriteRepository {
    ...
    createSeries(input: CreateSeriesInput): { success: true; series: Series } | { success: false; error: string } {
        ...
        const manifest = {
            ...
            publicationType: input.publicationType ?? "serial",
            lifecycleStatus: lifecycleStatusOf(input),
            status: lifecycleStatusOf(input),
        ...
        return {
            ...
            series: {
                ...
                publicationType: manifest.publicationType,
    ...
    updateSeries(seriesId: string, input: UpdateSeriesInput): { success: true; series: Series } | { success: false; error: string } {
        ...
        const updated: any = {
            ...
            ...((input.lifecycleStatus !== undefined || input.status !== undefined) && { lifecycleStatus: lifecycleStatusOf(input), status: lifecycleStatusOf(input) }),
        ...
        if (input.metadata === null) {
            ...
            updated.metadata = mergeMetadata(existing.metadata, input.metadata);
        }
        ...
        return {
            ...
            series: {
                ...
                publicationType: updated.publicationType ?? "serial",
                lifecycleStatus: updated.lifecycleStatus ?? updated.status ?? "ongoing",
