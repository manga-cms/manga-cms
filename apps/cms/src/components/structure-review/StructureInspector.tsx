                            ...
                            <div className="canonical-bubble-editor">
                                ...
                                <div className="lettering-editor-panel">
                                    <div className="canonical-bubble-header">
                                        ...
                                        <p>{t("structure.lettering.structureReviewDescription")}</p>
                                    </div>
                                    <div className="section-actions">
                                        ...
                                        <Link to={`/works/${seriesId}/episodes/${episodeId}/lettering`} className="btn btn-primary">
                                            {t("lettering.workspace.link")}
                                        </Link>
                                    </div>
                                    {!canManageLettering && <p className="card-meta">{t("structure.lettering.manageRightsRequired")}</p>}
                                </div>
                            </div>
                            {page && selectedPanel && (
